...
namespace OpenTK_winforms_z02
{
    public partial class Form1 : Form
    {
        ...
        //VARIABILE FOLOSITE IN TEMA
        private List<Vector3> loadedVertices = new List<Vector3>();
        // Orbital parameters
        private float earthOrbitSpeed = 4.0f; // Speed of Earth's orbit around the Sun
        private float moonOrbitSpeed = 25.0f; // Speed of Moon's orbit around the Earth
        private float sunRotationSpeed = 7.0f;

        private float moonInnerRotationSpeed = 10;
        private float earthInnerRotationSpeed = 20;

        private float earthOrbitRadius = 100.0f; // Distance from Sun to Earth
        private float moonOrbitRadius = 20.0f; // Distance from Earth to Moon
        ...
        private void LoadTextures()
        {
            ...
            LoadTexture(textures[2], "sun.jpg");
            LoadTexture(textures[3], "earth.jpg");
            LoadTexture(textures[4], "moon.jpg");
        }
        ...
        // CITIRE VERTEXURI DINTR-UN FISIER
        ...
        //DESENARE SPHERA CARE ORBITEAZA
